...
cidades = ["Barretos", "Jundiaí", "Franca", "Campinas", "Ribeirão Preto", "São Paulo", "Sorocaba", "Bauru"]
...
for time in times:
    for j in range(11):
        jogador = {
            ...
            "data_nascimento": f"{random.randint(1973, 2005)}-{random.randint(1, 12)}-{random.randint(1, 28)}",
            "idTime": time["id"]
        }
